...
WITH_AGENT_HINT = (
    "OmniUI explorer-app demo scripts require the explorer-app to be running in with-agent mode.\n"
    "Start it first:\n"
    "- demo\\java\\explorer-app\\run-dev-with-agent.bat"
)

_PREFERRED_PORT = 48111
