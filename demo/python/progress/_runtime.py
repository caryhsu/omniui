...
WITH_AGENT_HINT = (
    "OmniUI progress-app demo scripts require the progress-app to be running in with-agent mode.\n"
    "Start it first:\n"
    "- demo\\java\\progress-app\\run-dev-with-agent.bat"
)

_PREFERRED_PORT = 48104
