...
def generate_script(
    ...
    Args:
        ...
        skip_header: If ``True``, omit the ``# Generated by OmniUI Recorder``
            header and ``client = OmniUI.connect()`` preamble. Used when
            generating partial incremental output for real-time display.
    """
