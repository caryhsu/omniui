...
Define the double-click action behavior for the OmniUI Java agent: firing a synthesized `MouseEvent.MOUSE_CLICKED` with `clickCount=2` on a target JavaFX node.
