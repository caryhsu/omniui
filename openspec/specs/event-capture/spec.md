...
Capture user interaction events (mouse clicks, keyboard input) from a running JavaFX application via the Java agent, buffer them as structured JSON, and expose them through an HTTP endpoint.
