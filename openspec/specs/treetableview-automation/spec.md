...
Define the automation behavior for JavaFX `TreeTableView` controls in OmniUI, covering hierarchical row selection, cell value reading, and tree node expand/collapse.
